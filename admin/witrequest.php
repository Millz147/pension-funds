...
$sql = "SELECT * FROM employee WHERE withreq = '$yes'";
...
$ann++;
                     ...
                     echo "</td>
                      ...
                      <td>$baccna</td>
                     <td>$btype</td>
                     <td><a href=\"moneysent.php?rsa=$rsa&amo=$withamount&baccnu=$baccnu&baccna=$baccna&btype=$btype&datee=$datee&fn=$fn\"> SEND</a></td>
