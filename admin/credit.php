      ...
      <section class="wrapper">
        <div class="row">
          ...
          <form method="POST" action="credit.php">
            <input class=" form-control" id="cname" name="rsa" minlength="2" placeholder="RSA Number" type="text"  /><br><center>
...
<br>
<?php
                    echo "<a href=\"amount.php?rsa=$rsa&fna=$fna\">PROCEED TO CREDIT</a>";
                    ?>
                  </p>
                  <hr>
...
<script type="text/javascript">
  ...
  function credit1(){
var am = document.getElementId("amount1").value;
alert(am);
